...
namespace GreetingCard.Infrastructure
{
    public class GreetingCardContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Card>().Property(x => x.IsDelete).IsRequired();
            ...
            modelBuilder.Entity<Card>().Property(x => x.IsPublish).IsRequired();
            ...
            modelBuilder.Entity<Blog>().Property(x => x.IsDelete).IsRequired();
            modelBuilder.Entity<Blog>().Property(x => x.IsLock).IsRequired();
            ...
            modelBuilder.Entity<Comment>().Property(x => x.IsDelete).IsRequired();
            ...
            //Contact
            #region Contact
            modelBuilder.Entity<Contact>().Property(x => x.Id).IsRequired();
            ...
            modelBuilder.Entity<Contact>().Property(x => x.IsDelete).IsRequired();
            ...
            modelBuilder.Entity<Category>().Property(x => x.IsPublish).IsRequired();
            modelBuilder.Entity<Category>().Property(x => x.IsDelete).IsRequired();
